...
function BudgetOverviewStrip({ budgets, fmt }: { budgets: Budget[]; fmt: (n: number) => string }) {
  if (budgets.length === 0) return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 16px', background: 'var(--surface-2)', borderRadius: 10, fontSize: 12, color: 'var(--text-muted)' }}>
      ...
      <a href="/dashboard/budgets" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: 600 }}>Set budgets →</a>
    </div>
  );
...
function SavingsOverviewStrip({ goals, fmt }: { goals: SavingsGoal[]; fmt: (n: number) => string }) {
  ...
  if (goals.length === 0) return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 16px', background: 'var(--surface-2)', borderRadius: 10, fontSize: 12, color: 'var(--text-muted)' }}>
      ...
      <a href="/dashboard/savings" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: 600 }}>Create a goal →</a>
    </div>
  );
